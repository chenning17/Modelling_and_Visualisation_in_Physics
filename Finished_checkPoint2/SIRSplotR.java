...
public class SIRSplotR{
    ...
    public static void main (String[] args) throws Exception{
        ...
        for(int p1 = 0; p1<=detail; p1++){
            ...
            for(int p3 = 0; p3<=detail; p3++){
                ...
                for(int rep = 0; rep<=REPEATS; rep++){
                    ...
                    varianceSingleRun = (averageInfectedSquared - (averageInfected*averageInfected))/N;
        ...
        String fname = "p1-p3_ave_frac_Rep.dat";
        PrintWriter output = new PrintWriter(new FileWriter(fname));
        
        String fname2 = "p1-p3_variance_Rep.dat";
